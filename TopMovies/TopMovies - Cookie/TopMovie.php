...
<body>
    ...
    <?php
      // Formularioa bidaltzen bada
      if (isset($_POST["bidali"])) {
        // Cookie-ak ezarri, formularioaren balioekin, 3600 segundoz (ordu 1) ixten diren arte
        setcookie("izena", $_POST["izena"], time() + 3600); 
        setcookie("isan", $_POST["isan"], time() + 3600);
        setcookie("urtea", $_POST["urtea"], time() + 3600);
        setcookie("zenbakiak", $_POST["zenbakiak"], time() + 3600);
    }
    class TopMovies {
        private $izena;
        private $isan;
